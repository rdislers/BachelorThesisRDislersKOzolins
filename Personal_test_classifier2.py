...
lines=[]
for filename in os.listdir('C:/Users/hokej/Desktop/ai-job-title-area-classification-master/TestSource'):
    filenamefull='C:/Users/hokej/Desktop/ai-job-title-area-classification-master/TestSource/'+filename
...
for filename in os.listdir('C:/Users/hokej/Desktop/ai-job-title-area-classification-master/TestSource'):
    ...
    with open(filenamefull,encoding="utf8") as f:
        ...
        content["Department2"]=Department
        jsonname='C:/Users/hokej/Desktop/ai-job-title-area-classification-master/TestDestination/'+filename
